...
const RegistrationModal = ({ isOpen, onClose }) => {
   if (!isOpen) return null; // Не рендерити, якщо вікно закрите
   return (
      <Modal isOpen={isOpen} onClose={onClose}>
         ...
         <form action="#" className="flex flex-col items-center justify-center gap-4">
            <div className="w-full">
               ...
               <input type="text" placeholder='Владимир Зеленский' className="w-full p-2 mt-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-orange-500 focus:outline-none" id="fullname" />
            </div>
            <div className="w-full">
